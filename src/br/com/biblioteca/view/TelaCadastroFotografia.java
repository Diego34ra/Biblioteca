 ...
 * @author Diego
 */
public class TelaCadastroFotografia {
    ...
    public void start(Stage t) throws Exception {
        ...
        Parent painel = FXMLLoader.load(getClass().getResource("FXMLTelaCadastroFotografia.fxml"));
        scene = new Scene(painel);
        
        stage.setTitle("Cadastrar Fotografia");
